...
class Window(QMainWindow):
    ...
    def create_tab(self, id_profile):
        ...
        ###############Label id##########################
        self.labels_id_arr.append(QtWidgets.QLabel(id_profile, self.tabs_arr[-1]))
        ...
        ####################Message label##################
        self.labels_message_arr.append(QtWidgets.QLabel("Рассылка", self.tabs_arr[-1]))
        ...
        ####################IceBreaker label##################
        self.labels_ice_arr.append(QtWidgets.QLabel("IceBreker", self.tabs_arr[-1]))
